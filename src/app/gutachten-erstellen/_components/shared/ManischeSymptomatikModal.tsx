...
export function ManischeSymptomatikModal({
  ...
  const handleClearAndClose = () => {
    // Clear all CardSelection sections to empty objects
    setNestedField('manischeSymptomatik.stimmungEmotionalesErleben', {});
    setNestedField('manischeSymptomatik.antriebEnergiePsychomotorik', {});
    setNestedField('manischeSymptomatik.spracheKognition', {});
    setNestedField('manischeSymptomatik.vegetativeSymptome', {});
    setNestedField('manischeSymptomatik.selbsterleben', {});
    setNestedField('manischeSymptomatik.verhalten.selection', {});
    setNestedField('manischeSymptomatik.psychotischeSymptome', {});
    setNestedField('manischeSymptomatik.dissoziativeSymptome', {});
    // Impulsives Verhalten (CardSelection pattern)
    setNestedField('manischeSymptomatik.verhalten.impulsivesVerhalten.details', {});
    // Clear text fields
