...
export function DepressiveSymptomatikModal({
  ...
  const handleClearAndClose = () => {
    // Clear all selections by setting empty objects
    setNestedField('depressiveSymptomatik.stimmungEmotionalesErleben', {});
    setNestedField('depressiveSymptomatik.antriebEnergiePsychomotorik', {});
    setNestedField('depressiveSymptomatik.selbsterleben', {});
    setNestedField('depressiveSymptomatik.vegetativeSomatischeSymptome', {});
    setNestedField('depressiveSymptomatik.psychomotorischeSymptome', {});
    setNestedField('depressiveSymptomatik.kognition', {});
    setNestedField('depressiveSymptomatik.verhalten', {});
    setNestedField('depressiveSymptomatik.psychotischeSymptome', {});
    setNestedField('depressiveSymptomatik.dissoziativeSymptome', {});
    // Clear text field
