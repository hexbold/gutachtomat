...
export function ZwangssymptomatikModal({
  ...
  const handleDirectFieldChange = (field: 'zwanghafteIdeen' | 'zwangsimpulse', value: string) => {
    const data = ensureZwangsgedankenData();
    setNestedField('zwangssymptomatik.zwangsgedanken', {
      ...data,
      [field]: value
  ...
  const handleClearAndClose = () => {
    // Reset zwangsgedanken to empty object
    setNestedField('zwangssymptomatik.zwangsgedanken', {});
    // Reset zwangshandlungen to empty object
    setNestedField('zwangssymptomatik.zwangshandlungen', {});
    // Reset zwangsbezogene Kognitionen to empty object
    setNestedField('zwangssymptomatik.zwangsbezogeneKognitionen', {});
