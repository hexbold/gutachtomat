...
const STEPS: Step[] = [
  ...
  { number: 6, label: 'Diagnosen', icon: TagIcon, shortLabel: 'Diagnosen' },
            ...
            <div className="flex items-center justify-center">
              {STEPS.map((step, index) => {
                ...
                return (
                  ...
                  >
                    {/* Icon */}
                    <step.icon className={`w-4 h-4 ${status === 'current' || status === 'completed' || status === 'visited' ? 'text-white' : 'text-text-quaternary'}`} />
