...
function HelpText({ text }: { text?: string }) {
  if (!text) return null;
  return <p className="text-sm text-text-tertiary mb-2">{text}</p>;
}
  ...
  return (
    <div className="space-y-6">
      <section className="space-y-7 pb-8 border-b border-border-primary">
        ...
        <div>
          <FieldLabel
            ...
            required={true}
          />
          <HelpText text="Anonymisierte Kennung des Patienten" />
      ...
      <section className="space-y-4 pb-8">
        ...
        <HelpText text="Datum, an dem der Bericht erstellt wurde" />
