...
import { LockClosedIcon, BoltIcon, ClipboardDocumentCheckIcon, AdjustmentsHorizontalIcon } from '@heroicons/react/24/outline';
        ...
        <main className="flex-1 px-12 pt-12 pb-20">
          ...
          <div className="max-w-5xl mx-auto">
            ...
            <div className="relative">
              ...
              <div className="absolute left-6 top-6 bottom-6 w-1 bg-gradient-to-b from-blue-600 via-cyan-500 to-teal-600 rounded-full" />

              <div className="space-y-8">
                <div className="flex gap-6 items-start relative">
                  <div className="flex-shrink-0 w-12 h-12 bg-blue-700 text-white rounded-full flex items-center justify-center font-bold text-lg z-10 shadow-md">
                    1
                  </div>
                  <div className="flex-1 pt-2">
                    ...
                    <p className="text-foreground/70">
                      Wählen Sie die diagnostischen und patientenspezifischen Informationen einfach aus.
                    </p>
                  </div>
                </div>

                <div className="flex gap-6 items-start relative">
                  <div className="flex-shrink-0 w-12 h-12 bg-sky-600 text-white rounded-full flex items-center justify-center font-bold text-lg z-10 shadow-md">
                    2
                  </div>
                  <div className="flex-1 pt-2">
                    <h4 className="text-xl font-semibold text-foreground mb-2">
                    ...
                    <p className="text-foreground/70">
                      Der Gutachtomat erstellt auf Basis Ihrer Eingaben ein vollständiges und formal korrektes PTV3-Gutachten in wenigen Sekunden.
                    </p>
                  </div>
                </div>

                <div className="flex gap-6 items-start relative">
                  <div className="flex-shrink-0 w-12 h-12 bg-cyan-500 text-white rounded-full flex items-center justify-center font-bold text-lg z-10 shadow-md">
                    3
                  </div>
                  <div className="flex-1 pt-2">
                    <h4 className="text-xl font-semibold text-foreground mb-2">
                    ...
                    <p className="text-foreground/70">
                      Prüfen Sie das automatisch generierte PTV-3 Gutachten. Der Text kann jederzeit individuell angepasst und erweitert werden.
                    </p>
                  </div>
                </div>

                <div className="flex gap-6 items-start relative">
                  <div className="flex-shrink-0 w-12 h-12 bg-teal-400 text-white rounded-full flex items-center justify-center font-bold text-lg z-10 shadow-md">
                    4
                  </div>
                  <div className="flex-1 pt-2">
                    <h4 className="text-xl font-semibold text-foreground mb-2">
                    ...
                    <p className="text-foreground/70">
                      Laden Sie einfach und schnell Ihr vollständiges PTV3-Gutachten als PDF-Datei herunter.
                    </p>
                  </div>
                </div>
              </div>
