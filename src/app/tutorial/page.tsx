    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50/40 to-slate-100 dark:from-slate-900 dark:via-blue-950/40 dark:to-slate-900">
      <div className="max-w-7xl mx-auto px-6 sm:px-12 py-16">
        ...
        <div className="text-center max-w-3xl mx-auto mb-4">
          <h1 className="text-4xl md:text-6xl font-bold text-foreground mb-6 text-center">
            <span className="block whitespace-nowrap">Sehen Sie den <span className="text-blue-600 dark:text-blue-400">Gutachtomat</span></span>
            <span className="block text-blue-600 dark:text-blue-400">in Aktion</span>
          </h1>
      ...
      <section className="py-12 px-6 md:px-12 bg-gradient-to-b from-blue-200 to-blue-50 dark:from-blue-900 dark:to-blue-800">
        <div className="max-w-5xl mx-auto">
          <h2 className="text-3xl font-bold text-blue-600 dark:text-blue-400 text-center mb-2">
                ...
                <div className="bg-white dark:bg-gray-800 rounded-2xl p-3 shadow-xl border border-foreground/10">
                  <div className="aspect-video bg-gradient-to-br from-blue-50 to-blue-100 dark:from-blue-950/30 dark:to-blue-900/20 rounded-xl flex items-center justify-center">
                    <div className="text-center">
                      ...
                      <p className="text-foreground/40 text-sm font-medium">[Screenshot: Informationsauswahl]</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div>
                ...
                <ul className="space-y-2 text-foreground/70">
                  <li className="flex items-start gap-2">
                    ...
                    <span>Vollständige Sätze durch einige Klicks</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <svg className="w-5 h-5 text-sky-600 mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
