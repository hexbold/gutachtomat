...
import { ArrowRightCircleIcon, ClockIcon, StarIcon, CheckCircleIcon, ClipboardDocumentListIcon, AdjustmentsHorizontalIcon, LockClosedIcon, AcademicCapIcon, BookOpenIcon, BuildingOffice2Icon, ChevronDownIcon } from '@heroicons/react/24/outline';
      ...
      <section className="relative py-14 flex items-center justify-center overflow-hidden">
        <div className="text-center px-6 max-w-4xl mx-auto">
          <h1 className="text-4xl md:text-6xl font-bold mb-4">
            ...
            <span className="text-blue-600 dark:text-blue-400">Gutachtomaten</span>
          </h1>
          <p className="text-xl text-blue-600 dark:text-blue-400 font-bold max-w-4xl mx-auto">
      ...
      <main className="relative">
        ...
        <section id="intro" className="pt-1 pb-10 px-6 md:px-12 scroll-mt-20">
          <div className="max-w-5xl mx-auto text-center">
            <h2 className="text-3xl md:text-3xl font-bold text-blue-600 dark:text-blue-400 mb-3">
              Unser Ziel
            </h2>
        ...
        <section className="py-12 px-6 md:px-12 bg-gradient-to-b from-blue-200 to-blue-50 dark:from-blue-900 dark:to-blue-800">
          <div className="max-w-5xl mx-auto">
            <div className="text-center mb-12">
              <h2 className="text-3xl md:text-3xl font-bold text-blue-600 dark:text-blue-400 mb-4">
                      ...
                      <ul className="space-y-3">
                        {item.benefits.map((benefit, i) => (
                          <li key={i} className="flex items-start gap-2 text-white/90">
                            <span className="w-5 text-blue-200 mt-0.5">✓</span>
        ...
        <section className="py-12 px-6 md:px-12 bg-gradient-to-b from-blue-200 to-blue-50 dark:from-blue-900 dark:to-blue-800">
          <div className="max-w-5xl mx-auto">
            <div className="text-center mb-12">
              <h2 className="text-3xl md:text-3xl font-bold text-blue-600 dark:text-white mb-4">
                Ihre Vorteile
              </h2>
        ...
        <section className="py-12 px-6 md:px-12">
          <div className="max-w-4xl mx-auto text-center">
            <h2 className="text-3xl md:text-3xl font-bold text-blue-600 dark:text-blue-400 mb-6">
            ...
            <div className="bg-amber-50 dark:bg-amber-900/30 rounded-2xl shadow-lg p-6 md:p-8 border-2 border-amber-200 dark:border-amber-700/50">
              <div>
                <div className="flex items-center gap-3 mb-3">
                  ...
                  <h2 className="text-xl font-bold text-stone-900 dark:text-blue-400">
                    Wichtiger Hinweis
                  </h2>
                </div>
